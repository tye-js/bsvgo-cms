        ...
        <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          <div className="mb-5">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Chinese is the source draft. English can be generated by AI when creating a post.
            </p>
          </div>
        ...
        {generateEnglishFromChinese ? (
          <>
            ...
            <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-1 text-sm text-slate-500">
                English title, summary, body, and SEO fields are generated from the Chinese draft when this post is created.
              </p>
            </section>
          </>
        ) : (
          <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            <div className="mb-5">
              <h2 className="font-semibold text-slate-950">English content</h2>
              <p className="mt-1 text-sm text-slate-500">
                English version linked to the same article record.
              </p>
            </div>
            <div className="grid gap-4">
              <Field label="Title">
        ...
        <div className="sticky bottom-4 flex items-start gap-2 rounded-lg border border-slate-200 bg-white p-3 shadow-sm">
          <div className="grid flex-1 gap-2">
            ...
            <SubmitTimeoutNotice
              ...
              message={
                generateEnglishFromChinese
                  ? "English generation is taking longer than expected. The request will fail automatically if the AI service cannot finish soon. Wait for the error before submitting again."
                  : undefined
              }
            />
            <SubmitButton
              className="w-full"
              pendingLabel={generateEnglishFromChinese ? "Generating English..." : undefined}
              timeoutLabel={generateEnglishFromChinese ? "Generation timed out" : undefined}
              timeoutMs={submitTimeoutMs}
            >
              {submitLabel}
            </SubmitButton>
